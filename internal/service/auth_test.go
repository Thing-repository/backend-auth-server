...
//	type getUserByEmailMockBehavior func(s *mockService.MockuserDB, email string, userDB *core.UserDB)
...
//						Email:     pointy.String("foo@example.com"),
//					},
//
//					Id:           1,
...
//					DepartmentId: nil,
//				},
//				PasswordHash: pointy.String("test_password_hash"),
//			},
...
//			},
//			getUserByEmailMockBehavior: func(s *mockService.MockuserDB, email string, userDb *core.UserDB) {
//				s.EXPECT().GetUserByEmail(nil, email).Return(userDb, nil)
//			},
...
//			getUserByEmailMockBehavior: func(s *mockService.MockuserDB, email string, userDb *core.UserDB) {
//				s.EXPECT().GetUserByEmail(nil, email).Return(nil, moduleErrors.ErrorDatabaseUserNotFound)
//			},
//		},
//		{
...
//			getUserByEmailMockBehavior: func(s *mockService.MockuserDB, email string, userDb *core.UserDB) {
//				s.EXPECT().GetUserByEmail(nil, email).Return(nil, moduleErrors.ErrorDataBaseInternal)
//			},
//		},
//	}
//
...
//			testCase.inputAuthData.UserMail = *testCase.userDb.Email
//		}
//		emptyUser := core.User{}
...
//			db := mockService.NewMockuserDB(c)
//
...
//	type generateTokenMockBehavior func(s *mockService.Mocktoken, userId int, token string)
//	type addUserMockBehavior func(s *mockService.MockuserDB, userAddDb *core.AddUserDB, userDb *core.UserDB)
...
//				s.EXPECT().GenerateToken(userId).Return(token, nil)
//			},
//			addUserMockBehavior: func(s *mockService.MockuserDB, userAddDb *core.AddUserDB, userDb *core.UserDB) {
//				s.EXPECT().AddUser(nil, userAddDb).Return(userDb, nil)
//			},
...
//			addUserMockBehavior: func(s *mockService.MockuserDB, userAddDb *core.AddUserDB, userDb *core.UserDB) {
//				s.EXPECT().AddUser(nil, userAddDb).Return(nil, moduleErrors.ErrorDataBaseUserAlreadyHas)
//			},
//			generateHashMockBehavior: func(s *mockService.Mockhash, hash string, password string) {
//				s.EXPECT().GenerateHash(password).Return(hash, nil)
//			},
...
//			outputError: moduleErrors.ErrorDataBaseInternal,
//			addUserMockBehavior: func(s *mockService.MockuserDB, userAddDb *core.AddUserDB, userDb *core.UserDB) {
//				s.EXPECT().AddUser(nil, userAddDb).Return(nil, moduleErrors.ErrorDataBaseInternal)
//			},
//			generateHashMockBehavior: func(s *mockService.Mockhash, hash string, password string) {
//				s.EXPECT().GenerateHash(password).Return(hash, nil)
//			},
